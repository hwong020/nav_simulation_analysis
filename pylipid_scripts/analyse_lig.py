...
lipid = "LIG"   # residue name in the topology.
lipid_atoms = None  # all lipid atoms will be considered for interaction calculation.
cutoffs = [0.4, 0.8]  # dual-cutoff scheme for coarse-grained simulations. Single-cutoff scheme can be
...
timeunit = "ns"  # micro-sec. "ns" is nanosecond. Time unit used for reporting the results.
